...
<body>
	<!-- Start Header -->
	<header id="home">
		<video autoplay="" loop="" muted="" preload="true" id="myVideo">
		<source src="${pageContext.request.contextPath }/video/index.mp4" type="video/mp4"></video>
		<div class="home">
			<div class="hakunamatata-menu">
				<div class="container-xl">		
					<nav class="navbar navbar-expand-lg navbar-dark p-0">
						<a class="navbar-brand logo emphasized-phrase" href="hakunamatata/index">
							Hakuna Matata
						</a>
					...
					<div id="home-slide" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item">
								...
								<h1 class="emphasized-phrase slogan">Enjoy
									your life
								</h1>
								<hr>
							</div>
							<div class="carousel-item">
								<h2 class="creative-template">Hakuna Matata</h2>
								<h1 class="emphasized-phrase slogan">Discover
									the Word
								</h1>
								<hr>
							</div>
							<div class="carousel-item active">
								<h2 class="creative-template">Hakuna Matata</h2>
								<h1 class="emphasized-phrase slogan">Invest in
									yourself
								</h1>
								<hr>
							</div>
