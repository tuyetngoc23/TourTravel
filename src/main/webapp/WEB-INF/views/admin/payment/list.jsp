        ...
        <div class="content-wrapper">
           ...
           <div class="page-header">
        	...
        	<!-- table -->
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-center text-info">List Payment </h4>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                       <c:forEach var="payment" items="${paymentList}">
                      	<tr>
                          <td>${payment.id}</td>
                          <td>${payment.book.usertour.cusname}</td>	
                          <td>${payment.quantity}</td>	
                          <td><fmt:formatNumber value = "${payment.totalprice}" maxFractionDigits = "0"/> VNĐ</td>
                          <td>${payment.payment_type.type}</td>
                          <td><fmt:formatDate value="${payment.pdate}" pattern="dd-MM-yyyy" /></td>	
                        </tr>
                      </c:forEach> 
                      </tbody>
                    </table>
